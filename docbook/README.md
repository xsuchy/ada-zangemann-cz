...
- Epub generation doesn't seem to handle the image very well. Unsure what is going wrong. https://github.com/docbook/xslt10-stylesheets/blob/master/xsl/epub/bin/lib/docbook.rb#L167
